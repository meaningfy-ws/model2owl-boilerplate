...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>
            <xd:p>Project-level configuration for the ePO_core model2owl module.</xd:p>
            <xd:p>Values follow the eProcurement Ontology core configuration
                (OP-TED/epo-conceptual-model, release 5.2.0). The file keeps the
                model2owl-config template structure; parameters are grouped by purpose
                (see the numbered sections below and the accompanying README.md).</xd:p>
        </xd:desc>
    </xd:doc>
