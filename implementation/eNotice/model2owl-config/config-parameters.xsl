...
<!--    Set of variables for convention report-->
    ...
    <xsl:variable name="moduleReference" select="'eNotice'"/>
    <!--    dct:title -->
    <xsl:variable name="ontologyTitleCore" select="'eNotice core'"/>
    <xsl:variable name="ontologyTitleRestrictions" select="'eNotice restrictions'"/>
    <xsl:variable name="ontologyTitleShapes" select="'eNotice shapes'"/>
    <!--    dct:description-->
