...
<!--    Set of variables for convention report-->
    ...
    <xsl:variable name="moduleReference" select="'eContract'"/>
    <!--    dct:title -->
    <xsl:variable name="ontologyTitleCore" select="'eContract core'"/>
    <xsl:variable name="ontologyTitleRestrictions" select="'eContract restrictions'"/>
    <xsl:variable name="ontologyTitleShapes" select="'eContract shapes'"/>
    <!--    dct:description-->
