...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="ontologyTitleShapes" select="'Core Location Vocabulary - core shapes'"/>
    <!--    dct:description-->
    <xsl:variable name="ontologyDescriptionCore"
        select="'The Core Location Vocabulary core describes the concepts and properties representing the Core Location Vocabulary domain.'"/>
    <xsl:variable name="ontologyDescriptionRestrictions"
        select="'The Core Location Vocabulary core restrictions provides the restrictions and the inference-related specifications on the concepts and properties in the Core Location Vocabulary core.'"/>
    <xsl:variable name="ontologyDescriptionShapes"
        select="'The Core Location Vocabulary core shapes provides the generic datashape specifications for the Core Location Vocabulary core.'"/>
    <!--    rdfs:seeAlso -->
    ...
    <xsl:variable name="preferredNamespacePrefix" select="'cv'"/>
    <!--    dct:license-->
