...
This report is automatically generated from the diffusc3sCW5Ws RDF dataset on 29-Jun-2026T16:48:58
...
|This artefact consolidates both the definitions (OWL core) and the restrictions and inference-related specifications (OWL restrictions) of the eProcurement Ontology Core into a single self-contained ontology.
...
|ns2:PreMarketConsultationNotice
...
|ns2:SocialAndOtherSpecificServices-D23
...
|ns2:SocialAndOtherSpecificServices-D24
...
|ns2:VoluntaryEx-AnteTransparencyNotice
